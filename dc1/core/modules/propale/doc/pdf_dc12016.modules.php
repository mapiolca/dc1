 ...
 */
class pdf_DC12016 extends ModelePDFPropales
{
    	/**
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "DC1 2016";
		$this->description = $langs->trans('PDFDC1LMDBDescription2016');
	...
	function write_file($object,$outputlangs='',$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->propal->dir_output)
		{
			...
			// Page 1
                ...
                $pagecount = $pdf->setSourceFile(DOL_DOCUMENT_ROOT.'/custom/dc1/core/modules/propale/doc/DC1_2016/DC1-2016.pdf');
				...
				//Contenu
					...
					$pdf->writeHTMLCell(150,4, 20, 145, dol_htmlentitiesbr($outputlangs->convToOutputCharset($Client)),0,1);

					$pdf->writeHTMLCell(150,4, 20, 200, dol_htmlentitiesbr($outputlangs->convToOutputCharset($dc1_line->objet_consultation)),0,1);	
			...
			// Page 2
				...
				if ($dc1_line->objet_candidature == '1') {
					...
					$pdf->writeHTMLCell(190,4, 25, 51.7, dol_htmlentitiesbr("X"),0,1);

				} elseif ($dc1_line->objet_candidature == '2') {
					
					$pdf->writeHTMLCell(190,4, 25, 59.9, dol_htmlentitiesbr("X"),0,1);

					$pdf->writeHTMLCell(190,4, 68, 59.5, dol_htmlentitiesbr($dc1_line->n_lots),0,1);
					...
					$pdf->writeHTMLCell(190,4, 25, 91.3, dol_htmlentitiesbr("X"),0,1);
			...
			// Page 3
				...
				//Contenu
					...
					if ($dc1_line->candidat_statut == '1') {
						...
						$pdf->writeHTMLCell(190,4, 25, 43.6, dol_htmlentitiesbr("X"),0,1);
			...
			// Page 4
				...
				//Contenu
					...
					if ($dc1_line->dc2 == '1') {
						...
						$pdf->writeHTMLCell(190,4, 24.6, 242.3, dol_htmlentitiesbr("X"),0,1);
						
					}elseif($dc1_line->dc2 == '2') {
					
						$pdf->writeHTMLCell(190,4, 95, 242.3, dol_htmlentitiesbr("X"),0,1);
